...
const steps = [
    ...
    },
    {
        ...
        color: "text-primary", bg: "bg-green-50", border: "border-green-100",
    },
    {
...
export const HowItWorks = () => (
    <section id="how-it-works" className="section-padding bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative">
            ...
            >
                {steps.map((step, i) => (
                    <motion.div key={i} variants={itemVariants} className="group hover-lift">
                        <div className={`h-full p-6 rounded-2xl border ${step.border} bg-white hover:border-slate-200 transition-colors duration-200`}>
                            <div className="flex items-start justify-between mb-5">
                                <div className={`w-11 h-11 ${step.bg} ${step.color} rounded-xl flex items-center justify-center border ${step.border} group-hover:scale-110 transition-transform duration-200`}>
                                    {step.icon}
                                </div>
                ...
                <div className="relative z-10 grid lg:grid-cols-2 gap-12 p-10 lg:p-16 items-center">
                    <div className="space-y-8">
                        <h3 className="text-3xl md:text-4xl font-bold text-white leading-tight font-display">
                            Engineered for <br /><span className="text-primary">Global Impact</span>
                        </h3>
